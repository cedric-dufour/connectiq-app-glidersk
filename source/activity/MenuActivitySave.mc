...
class MenuActivitySave extends Ui.Menu {
  ...
  function initialize() {
    ...
    Menu.addItem(Lang.format("$1$ ?", [Ui.loadResource(Rez.Strings.menuActivitySave)]), :confirm);
  }

}

class MenuDelegateActivitySave extends Ui.MenuInputDelegate {
