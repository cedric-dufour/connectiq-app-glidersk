...
class GSK_PickerGenericSettings extends Ui.Picker {
  ...
  function initialize(_context, _item) {
    if(_context == :contextVariometer) {
      if(_item == :itemRange) {
        ...
        var oFactory = new PickerFactoryDictionary([0, 1], [Ui.loadResource(Rez.Strings.valueVariometerModeAltitude), Ui.loadResource(Rez.Strings.valueVariometerModeEnergy)], { :font => Gfx.FONT_TINY });
        Picker.initialize({
        ...
        Picker.initialize({
          :title => new Ui.Text({ :text => Lang.format("$1$ [%]", [Ui.loadResource(Rez.Strings.titleVariometerEnergyEfficiency)]), :font => Gfx.FONT_TINY, :locX=>Ui.LAYOUT_HALIGN_CENTER, :locY=>Ui.LAYOUT_VALIGN_BOTTOM, :color => Gfx.COLOR_BLUE }),
          :pattern => [ oFactory ],
      ...
      if(_item == :itemFinesse) {
        ...
        Picker.initialize({
          :title => new Ui.Text({ :text => Ui.loadResource(Rez.Strings.titleSafetyFinesse), :font => Gfx.FONT_TINY, :locX=>Ui.LAYOUT_HALIGN_CENTER, :locY=>Ui.LAYOUT_VALIGN_BOTTOM, :color => Gfx.COLOR_BLUE }),
          :pattern => [ oFactory ],
      ...
      if(_item == :itemDistance) {
        ...
        var oFactory = new PickerFactoryDictionary([-1, 0, 1 ,2], [Ui.loadResource(Rez.Strings.valueAuto), "km", "sm", "nm"], null);
        Picker.initialize({
        ...
        var oFactory = new PickerFactoryDictionary([-1, 0, 1], [Ui.loadResource(Rez.Strings.valueAuto), "m", "ft"], null);
        Picker.initialize({
        ...
        var oFactory = new PickerFactoryDictionary([-1, 0, 1], [Ui.loadResource(Rez.Strings.valueAuto), "mb", "inHg"], null);
        Picker.initialize({
        ...
        var oFactory = new PickerFactoryDictionary([-1, 0, 1], [Ui.loadResource(Rez.Strings.valueAuto), "°/s", "rpm"], null);
        Picker.initialize({
...
class GSK_PickerGenericSettingsDelegate extends Ui.PickerDelegate {
