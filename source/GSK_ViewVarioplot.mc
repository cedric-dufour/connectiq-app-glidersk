...
class GSK_ViewVarioplot extends Ui.View {
  ...
  function onShow() {
    //Sys.println("DEBUG: GSK_ViewVarioplot.onShow()");
  ...
  function updateUi() {
    //Sys.println("DEBUG: GSK_ViewVarioplot.updateUi()");
  ...
  function updateLayout() {
    //Sys.println("DEBUG: GSK_ViewVarioplot.updateLayout()");
