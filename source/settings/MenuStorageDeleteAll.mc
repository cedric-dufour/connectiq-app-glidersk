...
class MenuStorageDeleteAll extends Ui.Menu {
  ...
  function initialize() {
    ...
    Menu.addItem(Lang.format("$1$ ?", [Ui.loadResource(Rez.Strings.titleStorageDeleteAll)]), :confirm);
  }

}

class MenuStorageDeleteAllDelegate extends Ui.MenuInputDelegate {
