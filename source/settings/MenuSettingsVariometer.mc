...
class MenuDelegateSettingsVariometer extends Ui.MenuInputDelegate {
  ...
  function onMenuItem(item) {
    if (item == :menuVariometerRange) {
      //Sys.println("DEBUG: MenuDelegateSettings.onMenuItem(:menuVariometerRange)");
      ...
      //Sys.println("DEBUG: MenuDelegateSettings.onMenuItem(:menuVariometerMode)");
      ...
      //Sys.println("DEBUG: MenuDelegateSettings.onMenuItem(:menuEnergyEfficiency)");
      Ui.pushView(new PickerEnergyEfficiency(), new PickerDelegateEnergyEfficiency(), Ui.SLIDE_IMMEDIATE);
    }
    else if (item == :menuPlotRange) {
      //Sys.println("DEBUG: MenuDelegateSettings.onMenuItem(:menuPlotRange)");
