...
class MenuActivityDiscard extends Ui.Menu {
  ...
  function initialize() {
    ...
    Menu.addItem(Lang.format("$1$ ?", [Ui.loadResource(Rez.Strings.titleActivityDiscard)]), :confirm);
  }

}

class MenuActivityDiscardDelegate extends Ui.MenuInputDelegate {
